...
### M3: Modelling the effect of hull-mounted MFA sonar
...
Based on the resulting final posterior distribution of results (for model M3) we can use appropriate quantiles to obtain average predictions and intervals. Mathematical details of the procedure are given in Appendix S1.
