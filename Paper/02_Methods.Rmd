...
Finally, we calculated the expected change in the probability of detecting a GVP at each hydrophone $P(\text{GVP})$ relative to either the probability of detecting a GVP when no general naval training activity was present and no MFAS was present ($\Delta_{\texttt{M3:M1}}$), or relative to probability of detecting a GVP when general naval training activity was present but no MFAS was present ($\Delta_{\texttt{M3:M2}}$).
