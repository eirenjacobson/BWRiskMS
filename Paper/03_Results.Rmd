...
kable(table, caption="Number of hydrophones (HPs) used and number of observations made (no. 30-min periods) during each Submarine Commander Course before the exercise began, when naval activity was present, and when Naval activity and mid-frequency active (MFA) sonar were present.")
