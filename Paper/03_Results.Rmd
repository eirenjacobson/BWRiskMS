...
Hydrophone depths varied from `r range(baseline$Depth)[1])` to `r range(baseline$Depth)[2]`.   The model \texttt{M1} predicted highest probability of GVPs at hydrophone depths between 1500 and 2000 m, consistent with other findings that Blainville's beaked whales prefer to forage in slope habitats [CITE].
