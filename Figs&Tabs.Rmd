...
names(table) <- c("SCC", "HPs", "Pre-Exercise", "Phase A", "Phase B")
...
ggplot(rlDataSummary)+
  ...
  ylab("Percent of half hour periods with dives present")+
  xlab("")+
...
#  scale_x_date(date_breaks="3 days", date_labels="%d %b %y")+
  xlab("Day relative to first day of Phase A")+
...
polyDF$Period <- recode_factor(polyDF$Period, '00'="Baseline", '02'="Ships", "12"="Sonar")
