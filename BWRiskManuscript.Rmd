...
- Based on the raw data, the mean probability of diving across all hydrophones and SCCs decreased by `r round(naive[1], digits=2)` when ships were present and `r round(naive[3], digits=2)` when ships and sonar were present. 
