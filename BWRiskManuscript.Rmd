...
* Based on the raw data only, the probability of diving within a 30 min period changed by 
    + `r round(naive[1]*100)`\% when ships were present compared to when ships were absent
    + `r round(naive[2]*100)`\% when ships and sonar were present compared to when only ships were present
    + `r round(naive[3]*100)`\% when ships and sonar were present compared to when neither ships nor sonar were present
...
```{r fig6, eval=FALSE, fig.cap="Predicted probability of diving before, during Phase A, and during Phase B for all hydrophones and SCCs",, out.width='70%', fig.align='center'}

include_graphics("./Figures/predDive.pdf")
